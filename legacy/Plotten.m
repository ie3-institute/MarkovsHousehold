...
xlswrite('Lastverlaeufe_Darstellung.xlsx',A_w_Werktag,'Lastverläufe HH vor Versch.','B3'); %Winter Werktag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',A_w_Samstag,'Lastverläufe HH vor Versch.','C3'); %Winter Samstag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',A_w_Sonntag,'Lastverläufe HH vor Versch.','D3'); %Winter Sonntag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',A_s_Werktag,'Lastverläufe HH vor Versch.','E3'); %Sommer Werktag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',A_s_Samstag,'Lastverläufe HH vor Versch.','F3'); %Sommer Samstag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',A_s_Sonntag,'Lastverläufe HH vor Versch.','G3'); %Sommer Sonntag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',A_u_Werktag,'Lastverläufe HH vor Versch.','H3'); %Übergang Werktag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',A_u_Samstag,'Lastverläufe HH vor Versch.','I3'); %Übergang Samstag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',A_u_Sonntag,'Lastverläufe HH vor Versch.','J3'); %Übergang Sonntag abspeichern

%Übertragung des Restlastgangs
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Winter_Werktag_ohne,'Restlastgang','B3'); %Winter Werktag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Winter_Samstag_ohne,'Restlastgang','C3'); %Winter Samstag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Winter_Sonntag_ohne,'Restlastgang','D3'); %Winter Sonntag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Sommer_Werktag_ohne,'Restlastgang','E3'); %Sommer Werktag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Sommer_Samstag_ohne,'Restlastgang','F3'); %Sommer Samstag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Sommer_Sonntag_ohne,'Restlastgang','G3'); %Sommer Sonntag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Ubergang_Werktag_ohne,'Restlastgang','H3'); %Übergang Werktag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Ubergang_Samstag_ohne,'Restlastgang','I3'); %Übergang Samstag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Ubergang_Sonntag_ohne,'Restlastgang','J3'); %Übergang Sonntag abspeichern

%Übertragung des SLP
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Winter_Werktag,'SLP','B3'); %Winter Werktag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Winter_Samstag,'SLP','C3'); %Winter Samstag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Winter_Sonntag,'SLP','D3'); %Winter Sonntag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Sommer_Werktag,'SLP','E3'); %Sommer Werktag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Sommer_Samstag,'SLP','F3'); %Sommer Samstag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Sommer_Sonntag,'SLP','G3'); %Sommer Sonntag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Ubergang_Werktag,'SLP','H3'); %Übergang Werktag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Ubergang_Samstag,'SLP','I3'); %Übergang Samstag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',SLP_Ubergang_Sonntag,'SLP','J3'); %Übergang Sonntag abspeichern

%Übertragung der Lastverläufe der Verschiebbaren Lasten
xlswrite('Lastverlaeufe_Darstellung.xlsx',Ver_w_Werktag,'Lastverläufe Verschiebbare vor','B3'); %Winter Werktag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',Ver_w_Samstag,'Lastverläufe Verschiebbare vor','C3'); %Winter Samstag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',Ver_w_Sonntag,'Lastverläufe Verschiebbare vor','D3'); %Winter Sonntag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',Ver_s_Werktag,'Lastverläufe Verschiebbare vor','E3'); %Sommer Werktag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',Ver_s_Samstag,'Lastverläufe Verschiebbare vor','F3'); %Sommer Samstag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',Ver_s_Sonntag,'Lastverläufe Verschiebbare vor','G3'); %Sommer Sonntag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',Ver_u_Werktag,'Lastverläufe Verschiebbare vor','H3'); %Übergang Werktag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',Ver_u_Samstag,'Lastverläufe Verschiebbare vor','I3'); %Übergang Samstag abspeichern
xlswrite('Lastverlaeufe_Darstellung.xlsx',Ver_u_Sonntag,'Lastverläufe Verschiebbare vor','J3'); %Übergang Sonntag abspeichern

%%
%Auswahl des zu plottenden Lastverlaufs

Menue_Auswahl_Plot(Zeit, SLP_Winter_Werktag, SLP_Winter_Werktag_ohne, A_w_Werktag, ...
