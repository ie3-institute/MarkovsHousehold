...
for xyz = 1:1:Anzahl_Monte_Durchlaufe
    ...
    switch laufvariable1
        ...
        case 1
            Pzeitreihe_Monte_Matrix_Waschmaschine(:,xyz+3) = Pzeitreihe_Monte(start_Intervall_Simulation:end,:);
            Pzeitreihe_perhand_Waschmaschine = Pzeitreihe_perhand(start_Intervall_Simulation:end,:) * Anzahl_gereate;
            Pzeitreihe_Monte_Matrix_Waschmaschine(:,1) = Pzeitreihe_perhand_Waschmaschine;
        
        case 2
            Pzeitreihe_Monte_Matrix_Trockner(:,xyz+3) = Pzeitreihe_Monte(start_Intervall_Simulation:end,:);
            Pzeitreihe_perhand_Trockner = Pzeitreihe_perhand(start_Intervall_Simulation:end,:) * Anzahl_gereate;
            Pzeitreihe_Monte_Matrix_Trockner(:,1) = Pzeitreihe_perhand_Trockner;
            
        case 3
            Pzeitreihe_Monte_Matrix_Spuelmaschine(:,xyz+3) = Pzeitreihe_Monte(start_Intervall_Simulation:end,:);
            Pzeitreihe_perhand_Spuelmaschine = Pzeitreihe_perhand(start_Intervall_Simulation:end,:) * Anzahl_gereate;
            Pzeitreihe_Monte_Matrix_Spuelmaschine(:,1) = Pzeitreihe_perhand_Spuelmaschine;
