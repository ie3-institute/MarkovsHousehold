...
from markovs_household.data.appliance import ApplianceDataLoadProfile, ApplianceCategory
...
STOVE = ApplianceDataLoadProfile(category=ApplianceCategory.STOVE,
