...
from markovs_household.data.appliance import ApplianceDataLoadProfile, ApplianceType
...
STOVE = ApplianceDataLoadProfile(type=ApplianceType.STOVE, switch_on_probabilities=RANDOM_SWITCH_ON_PROBABILITIES, profile=LOAD_PROFILE_STOVE)
